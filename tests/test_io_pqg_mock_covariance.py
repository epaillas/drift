"""Tests for DS-galaxy mock covariance loading."""
...
def test_load_ds_mocks_reads_only_pqg_pattern(tmp_path, monkeypatch):
    for name in (
        "dsc_pkqg_poles_ph3001.h5",
        "dsc_pkqg_poles_ph3000.h5",
        "dsc_pkqq_poles_ph3000.h5",
        "mesh2_spectrum_poles_ph3000.h5",
    ):
        (tmp_path / name).touch()
    ...
    assert calls == ["dsc_pkqg_poles_ph3000.h5", "dsc_pkqg_poles_ph3001.h5"]
